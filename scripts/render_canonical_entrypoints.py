...
BEGINNER_AGENT_PROMPT = (
    ...
    "I say current repo, current folder, current one, or you are already working "
    "inside an empty target folder, use the current working directory as the "
    "target. If no target repo path or folder is clear, ask me for it before "
    "writing files.\n\n"
